...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <link rel="stylesheet" id="main-stylesheet" data-version="1.0.0" href="{{url('styles/shards-dashboards.1.0.0.min.css')}}">
    <link rel="stylesheet" href="{{url('styles/extras.1.0.0.min.css')}}">
  ...
  <body class="h-100">
            ...
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                <div class="d-table m-auto">
                  <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;" src="{{url('imageadmin/shards-dashboards-logo.svg')}}" alt="Shards Dashboard">
              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img class="user-avatar rounded-circle mr-2" src="{{url('imageadmin/avatars/0.jpg')}}" alt="User Avatar">
                  ...
                  <div class="card-body p-0">
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="imageadmin/avatars/1.jpg" alt="User avatar" /> </div>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="{{url('imageadmin/avatars/2.jpg')}}" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="{{url('imageadmin/avatars/3.jpg')}}" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
    ...
    <script src="{{url('scripts/extras.1.0.0.min.js')}}"></script>
    <script src="{{url('scripts/shards-dashboards.1.0.0.min.js')}}"></script>
    <script src="{{url('scripts/app/app-blog-overview.1.0.0.js')}}"></script>
  </body>
</html>